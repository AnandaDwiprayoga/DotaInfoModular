...
import com.pasukanlangit.id.ui_herodetail.R
...
@Composable
fun HeroBaseStats(hero: Hero, padding: Dp) {
    Surface(
        modifier = Modifier
            .fillMaxWidth()
        ,
            ...
            Row(
                ...
                Column(
                    ...
                    Row( // HP
                        ...
                        val health = remember{ (hero.baseHealth + hero.baseStr * 20).roundToInt()}
                        Text(
